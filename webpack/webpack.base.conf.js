  ...
  plugins: [
    ...
    new CopyWebpackPlugin({
      patterns: [
        ...
        { from: path.resolve(__dirname, '../src/assets/images/cattleya-logo.png'), to: 'assets/images/cattleya-logo.png' },
        { from: path.resolve(__dirname, '../src/assets/images/cattleya-logo.png'), to: 'favicon.ico' },
